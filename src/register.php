                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img class="d-block w-100 h-75" src="./assets/img/hotel-room6.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100 h-75" src="./assets/img/hotel-room7.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100 h-75" src="./assets/img/hotel-room-8.jpg" alt="Third slide">
                        </div>
                      </div>
